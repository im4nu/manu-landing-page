      ...
      <main className='flex flex-col w-screen text-primary-white'>
        <nav className='fixed w-screen py-8 px-9'>
          <ul className='flex w-full justify-around items-center flex-row text-sm'>
            ...
            <li><a href="#contats">Contatos</a></li>
          </ul>
        </nav>

        <section id='home' className='flex h-full flex-col w-screen text-primary-white'> 
          ...
          <div className="flex flex-col w-screen h-screen bg-hero bg-cover bg-right">
        ...
        <section id='about' className='flex flex-col w-screen gap-8 py-20'>
          <div className="flex flex-col text-primary-white text-center justify-center px-8 gap-8">
            ...
            <p>
              Eu me chamo Emmanuel Rodrigues, sou <span>WebDesigner</span> e <span>Programador</span>. Já fui gerente de T.I de um laboratório de análises clínicas e atuo na área da tecnologia a <span>mais de 7 anos</span>
            </p>

            <p className='text-sm'>
              Conheça alguns dos meus trabalhos, todos abaixo <span>são reais</span> e feitos para empresas de renome dentre o <span>mercado mundial</span>
            </p>
          </div>
        ...
        <section id='services' className='flex flex-col w-screen'>
          <div className="flex flex-col text-primary-white justify-center px-8 gap-8">
            ...
            <h2 className='text-4xl'>
              A tecnologia está presente em <span>todas as áreas</span> do mercado!
            </h2>
